...
var seriesType = H.seriesType, seriesTypes = H.seriesTypes, addEvent = H.addEvent, merge = H.merge, error = H.error,
    noop = H.noop, fireEvent = H.fireEvent, getColor = mixinTreeSeries.getColor,
