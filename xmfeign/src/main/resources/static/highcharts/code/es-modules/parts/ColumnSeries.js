...
var animObject = H.animObject, color = H.color, LegendSymbolMixin = H.LegendSymbolMixin, merge = H.merge, noop = H.noop,
    Series = H.Series, seriesType = H.seriesType, svg = H.svg;
/**
     ...
     */
    {
        ...
        pointAttribs: function (point, state) {
            var options = this.options, stateOptions, ret, p2o = this.pointAttrToOptions || {},
                ...
                opacity = pick(options.opacity, 1), zone, brightness;
            // Handle zone colors
